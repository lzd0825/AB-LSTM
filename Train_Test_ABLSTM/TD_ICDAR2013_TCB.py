...
def make_net():
  with open('./model/TD_ICDAR2013_TCB_train.pt', 'w') as f:
    f.write(str(net('train')))
  with open('./model/TD_ICDAR2013_TCB_test.pt', 'w') as f:
    f.write(str(net('test')))
def make_solver():
  sp = {}
  sp['net'] = '"./model/TD_ICDAR2013_TCB_train.pt"'
  ...
  sp['display'] = '10'
  sp['snapshot'] = '5000'
  sp['snapshot_prefix'] = '"./snapshot/TD_ICDAR2013_TCB/TD_ICDAR2013_TCB"'
  sp['gamma'] = '0.1'
  sp['max_iter'] = '400000'
  sp['solver_mode'] = 'GPU'
  f = open('./model/TD_ICDAR2013_TCB_solver.pt', 'w')
