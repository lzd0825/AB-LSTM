...
parser.add_argument('--model', type=str, default='../snapshot/TD_Total_Text_WSR/TD_Total_Text_WSR_iter_175000.caffemodel')
parser.add_argument('--net', type=str, default='../model/TD_Total_Text_WSR_test.pt')
