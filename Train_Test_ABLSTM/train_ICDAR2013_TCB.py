...
if not isfile('./model/TD_ICDAR2013_TCB_train.pt') or not isfile('./model/TD_ICDAR2013_TCB_test.pt') or not isfile('./model/TD_ICDAR2013_TCB_solver.pt'):
  from TD_ICDAR2013_TCB import make_all
  make_all()
...
caffe.set_mode_gpu()
caffe.set_device(0)
solver = caffe.SGDSolver('./model/TD_ICDAR2013_TCB_solver.pt')
